========================================================================
    DYNAMIC LINK LIBRARY: libeffects-android-Projektübersicht
========================================================================

Diese libeffects-android-DLL wurde vom Anwendungs-Assistenten für 
Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre libeffects-android-Anwendung besteht.


libeffects-android.vcxproj
...
libeffects-android.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "libeffects-android.pch und eine 
