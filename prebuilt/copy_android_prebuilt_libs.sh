...
cp ../dependencies/libeffects-android/libs/armeabi/libeffects.so android/armeabi/
...
cp ../dependencies/libeffects-android/libs/armeabi-v7a/libeffects.so android/armeabi-v7a/
...
cp ../dependencies/libeffects-android/libs/x86/libeffects.so android/x86/
